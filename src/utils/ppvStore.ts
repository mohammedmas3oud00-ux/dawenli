  ...
  return [
    {
      id: 'vault-1',
      pillar_id: pSelf,
      title: 'كتاب: العادات الذرية — جيمس كلير',
      vault_type: 'books',
...
3. القوانين الأربعة لتغيير السلوك: اجعلها واضحة، جذابة، سهلة، ومشبعة.`,
    ...
    },
    {
      id: 'vault-2',
      pillar_id: pSelf,
      title: 'مذكرة مبادئ: التفكير المنظومي في الحياة الشخصية',
      vault_type: 'notes',
      summary: 'ملخص لقواعد أوغست برادلي في بناء منظومة تشغيل شخصية تعتمد على التغذية الراجعة.',
      content: `العناصر المركزية:
- الركائز: مجالات الحياة الدائمة التي لا تنتهي أبداً.
- خطوط التدفق: نقل النية من الرؤية إلى هدف القيمة، إلى المشروع، ثم إلى المهام اليومية.
- الخزائن: قواعد البيانات المعرفية الداعمة للتنفيذ.
- حلقة التغذية الراجعة: المراجعات الدورية هي القلب النابض الذي يضمن التكيف السريع.`,
    ...
    },
    {
      id: 'vault-3',
      pillar_id: pWork,
      title: 'مرجع: أفضل ممارسات تصميم واجهات الويب الهادئة',
...
- استخدام زوايا بيضاوية ناعمة لتوفير شعور بالسكينة أثناء التصفح.`,
    ...
    },
    {
      ...
      content: `1. تصفية صندوق الوارد وتحويل كل فكرة إلى مهمة أو مرجع.
