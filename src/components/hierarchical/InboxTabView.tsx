...
import { deduplicateArabicSpeech } from '../../utils/speechRecognition';
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`p-2 rounded-lg transition-all cursor-pointer border ${
                isListeningDirect
                  ...
                  : 'bg-white text-[#56635c] border-[#d8d4cc] hover:text-[#174235] hover:border-[#174235]'
              }`}
            ...
            {onOpenVoiceAi && (
              <button
                ...
                className="p-2 rounded-lg bg-amber-50 text-amber-800 border border-amber-300 hover:bg-amber-100 transition-all cursor-pointer flex items-center gap-1 text-[11px] font-bold"
