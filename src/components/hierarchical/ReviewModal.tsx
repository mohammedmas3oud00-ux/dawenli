            ...
            <div className="space-y-4">
              ...
              <div className="bg-[#ebf4f0] border border-[#cfe3d9] rounded-2xl p-4 flex items-center justify-between">
                ...
                <button
                  ...
                  className="px-3 py-1.5 bg-white text-[#174235] border border-[#bcdbc9] hover:bg-[#faf9f6] rounded-xl text-xs font-bold transition-all shadow-2xs flex items-center gap-1.5 cursor-pointer shrink-0"
                >
